...
let player_status = {
  ...
  export function claw(health: number) {
  let damage = 10;
...
export function bite(health: number) {
  let damage = 15;
...
export function axe(health: number) {
  let damage = 25;
...
export function club(health: number) {
  let damage = 30;
...
export function knife(enemyHealth: number) {
  let damage = 12;
...
export function pistol(enemyHealth: number) {
  let damage = 30;
...
export function grenade(enemyHealth: number) {
  let damage = 50;
