...
if (guess.firstNum === num &&
    guess.secondNum === num &&
    guess.thirdNum === num) {
    console.log("Perfection. Very lucky indeed.");
}
else if (guess.firstNum === num && guess.secondNum === num) {
    console.log("Both your first and second guesses were correct. But why would you choose the same number two times instead of three?");
}
else if (guess.secondNum === num && guess.thirdNum === num) {
    console.log("Both your second and third guesses were correct. But why would you choose the same number two times instead of three?");
}
else if (guess.firstNum === num && guess.thirdNum === num) {
    console.log("Both your first and third guesses were correct. But why would you choose the same number two times instead of three?");
}
